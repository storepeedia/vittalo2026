  ...
  return (
    <div className="relative min-h-screen pb-20 bg-white">
      ...
      <div className="absolute top-0 w-full h-full z-0">
        <Image
          src="https://images.unsplash.com/photo-1585254691306-6d3b283880d7?q=80&w=928&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Hero background"
          fill
          priority
      ...
      <div className="relative z-10 bg-gray-50 pt-16 pb-16">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="md:hidden"><AutoScrollCarousel intervalMs={10000} itemCount={displayCamps.length}>
          ...
          <div className="md:hidden"><AutoScrollCarousel intervalMs={10000} itemCount={displayPackages.length}>
