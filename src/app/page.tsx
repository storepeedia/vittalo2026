    ...
    camps && camps.length > 0
      ...
      : [
          ...
          },
          {
            ...
            image_url:
              "https://images.unsplash.com/photo-1551524164-687a55dd1126?q=80&w=1925&auto=format&fit=crop",
          },
          {
            id: "4",
    ...
    packages && packages.length > 0
      ...
      : [
          ...
          },
          {
            ...
            starting_price: 999,
            image_url:
              "https://images.unsplash.com/photo-1513807016779-d51c0c026263?q=80&w=2070&auto=format&fit=crop",
          },
          {
            id: "3",
  ...
  return (
    <div className="relative min-h-screen pb-20 bg-white">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] text-center px-4 pt-32 pb-12">
        <p className="text-[#F59E0B] font-bold tracking-widest text-sm mb-4">
          EXPERIENCE MORE. LIVE MORE.
        </p>
        <h1 className="text-white text-5xl md:text-7xl font-bold max-w-4xl leading-tight mb-6">
          Travel differently. Experience more.
        </h1>
        <p className="text-gray-200 text-lg md:text-xl max-w-2xl mb-12">
          Adventure camps and unforgettable Europe journeys, made for you.
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-6 max-w-4xl w-full translate-y-12">
          <div className="bg-white rounded-2xl p-6 flex-1 flex items-center gap-6 shadow-2xl relative overflow-hidden group">
            ...
            <div className="bg-green-100 p-4 rounded-full relative z-10">
              <Tent className="text-green-700 w-8 h-8" />
            </div>
            <div className="text-left relative z-10 flex-1">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Discover our thrilling outdoor adventure camps.
              </p>
              <Link
                href="/camps"
                className="text-green-700 font-bold text-sm flex items-center hover:underline"
              >
                Explore Camps &rarr;
              </Link>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 flex-1 flex items-center gap-6 shadow-2xl relative overflow-hidden group">
            ...
            <div className="text-left relative z-10 flex-1">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Curated European packages for the perfect holiday.
              </p>
              <Link
                href="/packages"
                className="text-blue-700 font-bold text-sm flex items-center hover:underline"
              >
      ...
      <div className="relative z-10 bg-gray-50 pt-32 pb-16">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex justify-between items-end mb-10">
            ...
            <Link
              href="/camps"
              className="hidden md:flex text-gray-600 hover:text-gray-900 font-semibold items-center gap-1"
            >
              View all camps &rarr;
            </Link>
          </div>
      ...
      <div className="bg-[#FBF8F2] w-full py-20 relative z-10">
        <div className="container mx-auto px-6 max-w-6xl text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8 text-lg">
            Whether it's a family vacation or a couple's getaway, we plan the
            perfect itinerary for you.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <span className="bg-white px-4 py-2 rounded-full text-sm font-semibold shadow-sm border border-gray-100">
              Couples/Families
            </span>
            <span className="bg-white px-4 py-2 rounded-full text-sm font-semibold shadow-sm border border-gray-100">
              Custom Itinerary
          ...
          <Link
            href="#contact"
            className="inline-block bg-[#F59E0B] hover:bg-[#EAB308] text-white px-8 py-4 rounded-full font-bold transition-colors"
          >
            Plan My Trip &rarr;
          </Link>
        </div>
