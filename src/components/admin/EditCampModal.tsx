      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl my-8">
        ...
        <form onSubmit={handleSubmit} className="p-6 grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1">
             ...
             <input name="price_per_person" type="number" placeholder="Price per person (€)" defaultValue={camp.price_per_person} className="p-2 border border-black rounded text-gray-700 placeholder-gray-400" />
          </div>
          <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-1">
             ...
             <input name="price_per_person_pln" type="number" placeholder="Price per person (PLN)" defaultValue={camp.price_per_person_pln} className="p-2 border border-black rounded text-gray-700 placeholder-gray-400" />
          </div>
          <div className="flex flex-col gap-1 col-span-2">
